...
<div align="center">
  ...
  [![My Skills](https://skillicons.dev/icons?i=js,ts,java,html,css,py,arch,cpp,c,cs,lua,cloudflare,discord,bots,dotnet,docker,github,git,idea,linux,md,neovim,nodejs,obsidian,npm,postman,sqlite,visualstudio,vscode,windows,flask,fastapi,maven,react&perline=8&theme=dark)](https://skillicons.dev)
</div>
